...
export default function Footer() {
  return (
    <footer className="px-4 divide-y bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-600">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0" bis_skin_checked="1">
        <div className="lg:w-1/3" bis_skin_checked="1">
          <Link rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center h-16 rounded-full" bis_skin_checked="1">
              <img
            ...
            <span className="self-center text-2xl font-semibold">SBL Company</span>
          </Link>
        </div>
